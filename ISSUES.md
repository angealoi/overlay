...
| 2026-07-16 | **D1~D5 전부**: AOB 9패스→1패스 · HOM syscall 폭발 · 스네이킹 FBO 재사용 · SpriteManager 제거 · 에러바 할당 | `f4d21e0` `f13a42a` `2595e40` | 빌드 통과. **실측 미완 — osu! 실행 필요(D1 전후 비교)** |
...
> **D 섹션 5건 전부 해결** (`f4d21e0`, `f13a42a`, `2595e40`). **실측은 osu! 실행이 필요해 아직 못 했다** — D1 전후 비교 대기.
